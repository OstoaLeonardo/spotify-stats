...
export function Advantages() {
    return (
        <section className='flex flex-col sm:flex-row justify-between bg-eerie-black p-[12%] sm:p-[8%]'>
            <div className='w-full sm:w-1/2'>
                <div className='w-full'>
                    <p className='text-4xl sm:text-6xl font-bold'>
                        <span className='text-guppie-green'>Music </span>
                        what you listen,
                    </p>
                    <p className='text-4xl sm:text-6xl font-bold'>
                ...
                <div className='w-full flex flex-col items-center gap-8 sm:gap-10'>
                    {advantages.map((advantage, index) => (
                        <div key={index} className='w-full flex flex-row items-start gap-6'>
                            <span className='w-12 h-12 flex justify-center items-center bg-guppie-green/20 rounded-lg aspect-square'>
